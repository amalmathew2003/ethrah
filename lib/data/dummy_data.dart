...
class DummyData {
  ...
  static final Product ethnicSaree = Product(
    ...
    description:
        'Exquisite handwoven saree crafted with pure silk and traditional motifs.',
    imageUrl:
        'https://images.unsplash.com/photo-1629355889906-a1e6c86a9a90?w=500&q=80',
    category: 'ethnic',
    price: '₹12,500',
  ...
  static final Product ethnicLehenga = Product(
    ...
    description:
        'Stunning lehenga with intricate embroidery and mirror work. Perfect for festive occasions.',
    imageUrl:
    ...
    careInstructions:
        'Professional dry cleaning recommended. Handle embroidery with care.',
    galleryImages: [
  ...
  static final Product ethnicKurti = Product(
    ...
    description:
        'Modern kurti blending traditional patterns with contemporary silhouette.',
    imageUrl:
    ...
    careInstructions:
        'Machine wash in cold water. Air dry to maintain color vibrancy.',
    galleryImages: [
  ...
  static final Product contemporarySalwar = Product(
    ...
    description:
        'Clean lines and elegant draping define this modern salwar suit collection.',
    imageUrl:
        'https://images.unsplash.com/photo-1617197135910-4f952e2c99fa?w=500&q=80',
    category: 'contemporary',
    price: '₹9,500',
    material: 'Premium Cotton, Minimal Print',
    careInstructions:
        'Hand wash or gentle machine wash. Dry flat to prevent shrinking.',
    galleryImages: [
      'https://images.unsplash.com/photo-1617197135910-4f952e2c99fa?w=800&q=80',
      'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=800&q=80',
  ...
  static final Product contemporaryAnarkali = Product(
    ...
    description:
        'Blend of traditional anarkali with modern aesthetics and minimalist design.',
    imageUrl:
        'https://images.unsplash.com/photo-1585399592865-30fa38196e1a?w=500&q=80',
    category: 'contemporary',
    price: '₹11,000',
    material: 'Silk Blend, Subtle Embroidery',
    careInstructions:
        'Dry clean recommended for longevity. Store on padded hangers.',
    galleryImages: [
      'https://images.unsplash.com/photo-1585399592865-30fa38196e1a?w=800&q=80',
      'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&q=80',
      'https://images.unsplash.com/photo-1617197135910-4f952e2c99fa?w=800&q=80',
  ...
  static final Product jewellerySets = Product(
    ...
    description:
        'Handcrafted jewelry set featuring traditional motifs with contemporary design.',
    imageUrl:
    ...
    careInstructions:
        'Store in a dry place. Avoid contact with perfumes and cosmetics. Clean with soft cloth.',
    galleryImages: [
  ...
  static final Product jewelleryChandbali = Product(
    ...
    description:
        'Traditional chandbali earrings with pearls and gemstones in modern design.',
    imageUrl:
        'https://images.unsplash.com/photo-1515562141207-5daa5b88b57c?w=500&q=80',
    category: 'jewellery',
    price: '₹5,500',
    material: '18K Gold Plated, Natural Pearls',
    careInstructions:
        'Handle with care. Keep away from moisture. Polish gently with provided cloth.',
    galleryImages: [
      'https://images.unsplash.com/photo-1515562141207-5daa5b88b57c?w=800&q=80',
      'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
      'https://images.unsplash.com/photo-1515562141207-5daa5b88b57c?w=800&q=80',
  ...
  static final Product jewelleriBangles = Product(
    ...
    name: 'Bangle Set',
    description:
        'Exquisite bangle set combining traditional craftsmanship with elegance.',
    imageUrl:
        'https://images.unsplash.com/photo-1625458534895-fcf21eab32be?w=500&q=80',
    category: 'jewellery',
    price: '₹4,500',
    material: '22K Gold Plated Brass, Gemstones',
    careInstructions:
        'Remove before bathing. Store separately to avoid scratching. Avoid harsh chemicals.',
    galleryImages: [
  ...
  static final Collection ethnicCollection = Collection(
    ...
    name: 'Ethnic Wear',
    description:
        'Celebrate tradition with our premium ethnic collection featuring handwoven sarees, embroidered lehengas, and traditional wear.',
    coverImage:
        'https://images.unsplash.com/photo-1629355889906-a1e6c86a9a90?w=800&q=80',
  ...
  static final Collection contemporaryCollection = Collection(
    ...
    description:
        'Modern silhouettes with ethnic elements. Perfect for the contemporary woman who values tradition.',
    coverImage:
        'https://images.unsplash.com/photo-1617197135910-4f952e2c99fa?w=800&q=80',
  ...
  static final Collection jewelleryCollection = Collection(
    ...
    description:
        'Handcrafted jewelry pieces that add elegance to every occasion. Each piece tells a story.',
    coverImage:
        'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
  ...
  static final BrandInfo brandInfo = BrandInfo(
    ...
    story:
        'Ethrah means abundance, beauty and inner radiance. It represents a person who carries elegance, confidence and a natural glow that shines from within. Our brand is inspired by the timeless beautyb  e with us on this Journey.',
    mission:
        'To create exquisite ethnic and contemporary wear that empowers women to express their identity with pride and elegance.',
    vision:
        'To become the go-to destination for women seeking premium, ethically-crafted ethnic wear and jewelry that transcends generations.',
    founderNote:
        'This brand was born from a love for timeless style and meaningful design. Every piece we sell—whether clothing or jewelry—is chosen to help you express yourself with confidence and ease. We believe in quality, simplicity, and details that make a difference. Thank you for being part of our journey.',
